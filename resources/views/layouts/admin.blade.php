...
<body class="admin-dashboard-body">
    ...
    <div class="admin-dashboard-wrapper">
        ...
        <aside class="admin-sidebar">
            ...
            <nav class="admin-sidebar-nav">
                ...
                <a href="/admin/about" class="admin-nav-link {{ Request::is('admin/about*') && !Request::is('admin/about-page*') ? 'active' : '' }}">
                ...
                @php
                    $isPagesActive = Request::is('admin/about-page*') || Request::is('admin/team*') || Request::is('admin/our-service-page*');
                @endphp
                ...
                <div class="admin-submenu-container {{ $isPagesActive ? 'open' : '' }}" id="pagesSubmenu">
                    ...
                    <a href="/admin/our-service-page" class="admin-submenu-link {{ Request::is('admin/our-service-page*') ? 'active' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="margin-right: 8px;"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>
                        Our Service
                    </a>
                </div>
    ...
    <script>
        function togglePagesSubmenu(btn) {
            btn.classList.toggle('open');
            const container = document.getElementById('pagesSubmenu');
            if (container) {
